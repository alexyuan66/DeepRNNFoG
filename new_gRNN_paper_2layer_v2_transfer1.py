...
#model.save(sys.argv[1] + '_' + TFILE + '_' + str(predict_d) + '.h5')
#exit(0)

model1 = load_model('model/'+sys.argv[1] + '_Allbut' + TFILE[:-1] + '_' + str(predict_d) + '.h5')
...
model1.fit(XXX, YYY, batch_size=batch_size, epochs=epoches)

Out = model1.predict(XXX, verbose=0)
