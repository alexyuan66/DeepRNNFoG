...
def parse_commandline():
    ...
    if len(sys.argv) > 1:
        if sys.argv[1] == 'SimpleRNN' :
            ...
            print('Usage: python3 Alex_gRNN_paper.py [(B)SimpleRNN|(B)LSTM|(B)GRU] [acti] [n_a] [Tx] [predict_d] [Tstep] [Tcutoff] [Sstep] [batch_size] [epoches] [TFILE] [XXX] [YYY] [TFILE2] [XXXYYY2]')
            exit(0)
